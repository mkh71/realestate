        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                <a class="d-block mb-2" href="#">
                    <img src="{{asset('storage/'.company()->footer_logo)}}" alt="HomeID">
                </a>
                <div class="lh-26 font-weight-500">
                    <p class="mb-0">{{company()->about_footer}}</p>
                </div>
                <div class="lh-26 font-weight-500">
                    ...
                    <a class="d-block text-muted hover-white" href=".">www.abarrealestate.com</a>
                </div>
            </div>
        ...
        <div class="mt-0 mt-md-10 row">
            <ul class="list-inline mb-0 col-md-6 mr-auto">
                <li class="list-inline-item mr-6">
                    <a href="{{route('tc_pp')}}" class="text-muted lh-26 font-weight-500 hover-white">Terms of Use</a>
                </li>
                <li class="list-inline-item">
                    <a href="{{route('tc_pp')}}" class="text-muted lh-26 font-weight-500 hover-white">Privacy Policy</a>
                </li>
            </ul>
            <p class="col-md-auto mb-0 text-muted">
                © {{date('Y')}} Abar Real Estate. All Rights Reserved
            </p>
        </div>
    </div>
</footer>
            ...
            <div class="modal-body p-4 py-sm-7 px-sm-8">
                <div class="tab-content shadow-none p-0" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                        ...
                        <div class="mt-2">By creating an account, you agree to Abar Real Estate
                            <a class="text-heading" href="{{route('tc_pp')}}"><u>Terms of Use</u> </a> and
                            <a class="text-heading" href="{{route('tc_pp')}}"><u>Privacy Policy</u></a>.
                        </div>
                    </div>
                </div>
            </div>
