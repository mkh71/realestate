...
<head>
    ...
    <title>ABAR R.Estate Dashboard | @yield('title')</title>
    ...
    <style>
        ...
        #mainnav-menu svg.icon {
            padding: 0 5px 0 0 !important;
            font-size: 22px;
        }
        #mainnav-menu>.active-sub {
        ...
        .menu-item:hover, .sidebar-item-active
        {
            display: block;
        }
        svg.icon {
        ...
        $(function() {
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: url,
                    data: {'status': status, 'id': id, 'model':model, _token: token},
...
<div id="container" class="effect aside-float aside-bright mainnav-lg">
            ...
            <div class="navbar-header">
                <a href="{{route('index')}}" class="navbar-brand">
                    ...
                    <div class="brand-title">
                        <span class="brand-text">ABAR<span class="text-warning text-bold">R.Estate</span> </span>
                    </div>
                </a>
            </div>
            <!--================================-->
                ...
                <ul class="nav navbar-top-links">
                    ...
                    <li id="dropdown-user" class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                            <ul class="head-list">
                                <li>
                                    <a href="{{route('my_profile')}}"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                                </li>
                                <li>
    ...
    @else
        @include('backend.layouts.user-menu')
    @endif
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title col-lg-6 col-sm-6">
                                    @yield('panel-title')
                                </h3>
                                <h3 class="pull-right text-right panel-title col-lg-6 col-sm-6">
                                    @yield('right-title')
                                </h3>
                            </div>
...
<!-- FOOTER -->
    ...
    <footer id="footer">
        ...
        <div class="hide-fixed pull-right pad-rgt">
            Developed By <strong>@MKH</strong>.
        </div>
        ...
        <strong class="pad-lft"><i>{{date('Y')}} &#0169; <b>Copyright - </i> ABAR REAL ESTATE</b></strong>
