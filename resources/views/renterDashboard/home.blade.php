                                ...
                                <div class="dropdown px-3">
                                    <a href="#" class="dropdown-toggle d-flex align-items-center text-heading"
                                       data-toggle="dropdown">
                                        <div class="w-48px">
                                            <img src="{{$user->image ? asset('storage/'.$user->image) : asset('website/images/my-profile.png')}}"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{route('logout') }}"
                                           ...
                                           class="text-heading lh-1 sidebar-link">Logout</a>
                ...
                <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                    <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                        <div class="mr-0 mr-md-auto">
                            <h2 class="mb-0 text-heading fs-22 lh-15">@yield('panel-title')
                                <span
                                    class="badge badge-white badge-pill text-primary fs-18 font-weight-bold ml-2">@yield('panel-no')</span>
                            </h2>
                        </div>
